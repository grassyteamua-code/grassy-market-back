...
## ⚒️ Тестування:
  ...
  - **Mocha** — [https://mochajs.org/](https://mochajs.org/) (багатофункціональний фреймворк для тестування **JavaScript**, що працює на **Node.js** і в браузері, роблячи асинхронне тестування простим і цікавим. Тести Mocha виконуються послідовно, що дозволяє створювати гнучкі та точні звіти, одночасно зіставляючи невиявлені винятки з правильними тестовими випадками)
